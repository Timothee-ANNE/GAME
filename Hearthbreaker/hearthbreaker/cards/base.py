...
class Card(Bindable, GameObject):
    ...
    def mana_cost(self):
        ...
        if hasattr(self, '_calculating_mana_cost'):
            return self.mana  # Return base mana to break recursion
        
        self._calculating_mana_cost = True
        try:
            ...
            delattr(self, '_calculating_mana_cost')
        
    def old_mana_cost(self):
        """
